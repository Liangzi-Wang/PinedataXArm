...
###
def save_trajectory_to_h5(tcp_poses, joint_poses, forces, timestamps, episode_time):
    """Save robot trajectory data to HDF5 file"""
    data_folder = os.path.expanduser("~/pine_data/recordings_trajectories")
        ...
        try:
            if key.char == 'r':
                ...
                if not recording:
                    ...
                    current_episode_folder = os.path.join(data_folder, current_episode_time)
                ...
                if recording:
                    ...
                    save_trajectory_to_h5(tcp_pose_array, joint_pose_array, force_array,
                                         timestamp_array, current_episode_time)
