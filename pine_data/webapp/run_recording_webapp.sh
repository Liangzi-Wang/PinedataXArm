...
export XARM_TELEOP_ANGULAR_SPEED
export XARM_MOVE_ACCELERATION
export XARM_COMMAND_PERIOD_S
export XARM_TELEOP_CONTROL_MODE
export XARM_COMMAND_TRANSLATION_MAP
export SPACEMOUSE_QUEUE_HOST
export SPACEMOUSE_QUEUE_PORT
export SPACEMOUSE_QUEUE_AUTHKEY
export SPACEMOUSE_QUEUE_PUBLISH_HZ
export SPACEMOUSE_RESPONSE_EXPONENT
export XARM_QUEUE_POLL_HZ
