...
class SpaceMouseReader:
    def __init__(self) -> None:
        ...
        self.response_exponent = max(0.1, env_float("SPACEMOUSE_RESPONSE_EXPONENT", 2.0))
...
def main() -> None:
    ...
    parser.add_argument("--publish-hz", type=float, default=max(1.0, env_float("SPACEMOUSE_QUEUE_PUBLISH_HZ", 100.0)))
    ...
    server_thread.start()
    print(f"[SpaceMouse] queue server listening on {args.host}:{args.port}")
